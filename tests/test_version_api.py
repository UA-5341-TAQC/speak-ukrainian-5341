...
class TestVersionApi:
    ...
    def test_version_endpoint_returns_metadata(self, version_api: VersionClient) -> None:
    ...
    @allure.tag("api", "smoke", "version")
    def test_version_endpoint_returns_json(self, version_api: VersionClient) -> None:

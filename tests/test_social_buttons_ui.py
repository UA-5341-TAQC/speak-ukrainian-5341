...
@allure.title("TC-47: Verify 'Допомогти проєкту' button display, styling, and payment redirection")
@allure.description("Test verifies that the donation button is displayed, "
...
def test_tc47_donate_button_redirects_to_wayforpay(
    ...
    with allure.step(
        "Step 4: Verify donation button is displayed"
    ):

...
class ChallengeVideoCard(BaseComponent):
    ...
    _TITLE: Locator = (By.XPATH, ".//*[self::h2 or self::h3 or self::h4][1]")
    _THUMBNAIL: Locator = (By.CSS_SELECTOR, "img")
    _PLAY_BUTTON: Locator = (
        By.XPATH,
        ".//*[self::button or @role='button'][contains(@class, 'play') or .//*[name()='svg']]",
    )
    _YOUTUBE_LINK: Locator = (By.XPATH, ".//a[normalize-space()='Дивитися на YouTube']")
    ...
    def is_thumbnail_loaded(self) -> bool:
        ...
        thumbnail = self._find_element(self._THUMBNAIL)
